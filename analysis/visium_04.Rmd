...
```{r}
dat <- qs_read(file.path(here::here(), "data", "visium", "data", "visium_seurat_qced_norm.qs2"))
dat
```
...
sc_data <- qs_read(file.path(here::here(), "data", "visium", "data", "sc_seurat_object_10x.qs2"))
...
# qsave the object
qs_save(RCTD, file.path(here::here(), "data", "visium", "data", "rctd_decon_out.qs2"))
```
