...
The data can be downloaded from Google drive link in setup page or from [10x website](https://www.10xgenomics.com/products/visium-hd-spatial-gene-expression/dataset-human-crc).
If you choose to do the latter, make sure you choose Visium CytAssist v2 Sample P2 CRC on the tab on the left.
...
```{r}
dat <- Load10X_Spatial(
  data.dir = file.path(here::here(), "data", "visium"),
