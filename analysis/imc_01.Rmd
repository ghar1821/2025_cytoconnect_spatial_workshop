...
Add a small amount of gaussian blur to reduce noise.
Gaussian blur will diffuse the image slightly, which will cause pixels with low expression of membrane markers to appear more diffuse.
By making these pixels less distinct, we can help prevent them from being mistakenly identified as part of a cell membrane.
